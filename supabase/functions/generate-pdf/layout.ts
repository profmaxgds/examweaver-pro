    ...
    const styles = `
        ...
        *, *::before, *::after {
        ...
        .custom-header { 
            ...
            align-items: stretch; 
            border-bottom: 1px solid #000; /* Reduzido de 2px para 5px */
            padding-bottom: 10px; 
            margin-bottom: 15px; 
            font-size: 11pt; 
            line-height: 1.3; 
        ...
        .grade-container { 
            ...
            text-align: right; 
            margin-left: 15px; 
            gap: 2px; /* Reduzido o espaço entre Nota e Data */
        }
        .grade-box { 
            border: 1px solid #000; 
            padding: 20px 5px; 
            ...
            font-weight: bold; 
            flex-grow: 1; 
            margin-bottom: 0; /* Removido margem inferior para reduzir espaço */
        }
        .date { 
            font-size: 10pt; 
            text-align: right; 
            margin: 0; /* Removido margem para reduzir espaço */
        }
        ...
        .anchor-top-left { top: -7px; left: -7px; }
        .anchor-top-right { top: -7px; right: -7px; }
        .anchor-bottom-left { bottom: -7px; left: -7px; }
        .anchor-bottom-right { bottom: -7px; right: -7px; }
                ...
                options.forEach((letter, i) => {
                    ...
                    if (includeAnswers && q) {
                        if (q.type === 'multiple_choice') {
                            ...
                            isCorrectAnswer = correctOption && i < q.options.length && q.options[i].id === correctOption.id;
                        } else if (q.type === 'true_false') {
